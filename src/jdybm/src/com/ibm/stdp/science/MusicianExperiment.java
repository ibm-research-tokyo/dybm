...
/*
 * Experiments for associative memory for a time-series of Ich bin ein Musikante
 * @author osogami
 */
public class MusicianExperiment {
	...
	// prediction
	TimeSeries prediction = ann.freeRun(trainingData.getPeriod()+1,0);
	System.out.println("prediction:");
	System.out.println(prediction);
